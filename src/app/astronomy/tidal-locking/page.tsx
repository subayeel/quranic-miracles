                            ...
                            <Card className="border-l-4 border-purple-500">
                                ...
                                <CardContent className="pt-4 space-y-4">
                                    <p className="font-medium">
                                        ...
                                        one side of a celestial body always faces another body during its orbit.
                                    </p>
                                    <div className="bg-purple-50 dark:bg-purple-900/30 p-6 rounded-lg border border-purple-100 dark:border-purple-800">
                                        ...
                                        <p>
                                            In the case of tidal locking, the same side of a moon or planet
                                            continuously faces its parent star or planet. A perfect example
                                            is our own Moon, which always shows the same face to Earth.
                                        </p>
                                    </div>
                                </CardContent>
                            </Card>
                                ...
                                <CardContent className="pt-4 space-y-4">
                                    <div className="bg-blue-50 dark:bg-blue-900/30 p-6 rounded-lg border border-blue-100 dark:border-blue-800">
                                        <h3 className="font-medium mb-2 flex items-center gap-2">
                                            <Quote size={16} className="text-blue-500" /> Tidal Locking Definition
                                        </h3>
                                        <p className="italic text-gray-700 dark:text-gray-300">
                                            "Tidal locking between a pair of co-orbiting astronomical bodies
                                            occurs when one of the objects reaches a state where there is no
                                            longer any net change in its rotation rate over the course of a
                                            complete orbit. In the case where a tidally locked body possesses
                                            synchronous rotation, the object takes just as long to rotate
                                            around its own axis as it does to revolve around its partner.
                                            For example, the same side of the Moon always faces Earth..."
                                        </p>
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-6">
                                        <div className="bg-gray-100 dark:bg-gray-800 p-4 rounded-lg">
                                            <h3 className="font-medium mb-2 flex items-center gap-2">
                                                <Sparkles size={16} className="text-yellow-500" /> Energy Transfer
                                            </h3>
                                            <p>
                                                Tidal bulges transfer rotational kinetic energy between celestial
                                                bodies. This process gradually synchronizes their rotation and
                                                orbital periods.
                                            </p>
                                        </div>
                                        <div className="bg-gray-100 dark:bg-gray-800 p-4 rounded-lg">
                                            <h3 className="font-medium mb-2 flex items-center gap-2">
                                                <Star size={16} className="text-gray-500" /> Eventual Synchronization
                                            </h3>
                                            <p>
                                                Over time, Earth also transfers rotational energy to the Sun,
                                                though this process is much slower due to the greater distance.
                                            </p>
                                        </div>
                                    </div>
                                </CardContent>
                                ...
                                <CardContent className="pt-4 space-y-4">
                                    ...
                                    <div className="mt-6">
                                        ...
                                        <p className="mt-3">
                                            ...
                                            where the same side of a celestial body always faces its star.
                                        </p>
                                    </div>
                                </CardContent>
                            </Card>
                                ...
                                <CardContent className="pt-4 space-y-4">
                                    ...
                                    <div className="bg-amber-50 dark:bg-amber-900/30 p-6 rounded-lg border border-amber-100 dark:border-amber-800">
                                        <h3 className="font-bold text-xl mb-3 text-center">
                                            ...
                                            known about tidal locking?
                                        </h3>
                                        <p>The subtle reference to a potential stillness of shadow
                                            remarkably aligns with our contemporary scientific
                                            understanding of tidal locking. This phenomenon, where
                                            one side of a celestial body perpetually faces its parent
                                    ...
                                    <p>
                                        ...
                                        approached from a scientific or spiritual perspective,
                                        tidal locking continues to inspire wonder and discovery.
                                    </p>
                                </CardContent>
                            </Card>
                        </section>
            ...
            <footer className="bg-gray-100 dark:bg-gray-800 py-8 mt-12">
                <div className="max-w-7xl mx-auto px-4 text-center">
                    <div className="flex justify-center items-center gap-2 mb-4">
                        ...
                        <h3 className="text-lg font-medium">Exploring Celestial Mechanics</h3>
                    </div>
                    <p className="text-gray-600 dark:text-gray-400 max-w-lg mx-auto">
                        The universe reveals its secrets through intricate dance of
                        gravitational forces, connecting ancient wisdom with modern discovery.
                    </p>
