                    ...
                    <div className="lg:col-span-3 space-y-12">
                            ...
                            <Card className="border-l-4 border-orange-500">
                                ...
                                <CardContent className="pt-4 space-y-4">
                                    <p className="font-medium">
                                        In the Quran days on earth are getting longer. Skeptics claim that whoever wrote the Quran made a mistake; a day was and will always be 24 hours. Today scientists confirm that days are getting longer.
                                    </p>
                                    <div className="bg-orange-50 dark:bg-orange-900/30 p-6 rounded-lg border border-orange-100 dark:border-orange-800">
                                        ...
                                        <p>
                                            The rotation of Earth is slowing down, which means days were shorter in the past. This gradual change continues today, with our planet's rotation becoming incrementally slower over time.
                                        </p>
                                    </div>
                                </CardContent>
                            </Card>
                                ...
                                <CardContent className="pt-4 space-y-4">
                                    <div className="bg-blue-50 dark:bg-blue-900/30 p-6 rounded-lg border border-blue-100 dark:border-blue-800">
                                        <h3 className="font-medium mb-2 flex items-center gap-2">
                                            <Quote size={16} className="text-blue-500" /> Scientific Confirmation
                                        </h3>
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-6">
                                        <div className="bg-gray-100 dark:bg-gray-800 p-4 rounded-lg">
                                            <h3 className="font-medium mb-2 flex items-center gap-2">
                                                <RotateCcw size={16} className="text-blue-500" /> Slowing Rotation
                                            </h3>
                                            <p>
                                                The rotation of Earth is slowing down, making days slightly longer over time. This occurs primarily due to tidal friction caused by the Moon's gravitational pull.
                                            </p>
                                        </div>
                                        <div className="bg-gray-100 dark:bg-gray-800 p-4 rounded-lg">
                                            <h3 className="font-medium mb-2 flex items-center gap-2">
                                                <Clock size={16} className="text-gray-500" /> Measurable Change
                                            </h3>
                                            <p>
                                                Modern atomic clocks can measure this change with precision, showing that a day is approximately 1.7 milliseconds longer now than it was a century ago.
                                            </p>
                                        </div>
                                    </div>
                        ...
                        <section id="reflection" className="scroll-mt-20">
                            <Card className="border-l-4 border-amber-500">
                                ...
                                <CardContent className="pt-4 space-y-4">
                                    <p>
                                        The correlation between modern scientific findings and the Quranic verse raises an intriguing question:
                                    </p>

                                    <div className="bg-amber-50 dark:bg-amber-900/30 p-6 rounded-lg border border-amber-100 dark:border-amber-800">
                                        <h3 className="font-bold text-xl mb-3 text-center">
                                            How could an illiterate man who lived 1400 years ago have known that days are getting longer?
                                        </h3>
                                        <p>
                                            The subtle lengthening of Earth's day—a phenomenon that requires atomic clocks and centuries of astronomical data to measure accurately—appears to be referenced in a text from the 7th century. This connection between ancient scripture and modern scientific discovery invites contemplation about the origins of knowledge.
                                        </p>
                                    </div>

                                    <p>
                                        This phenomenon—that Earth's rotation is gradually slowing, causing days to lengthen over time—was completely unknown in the ancient world and would have been impossible to detect without modern scientific instruments. The reference in the Quran to the persistent extension of day and night aligns remarkably with what science has only recently confirmed.
                                    </p>
                                </CardContent>
                            </Card>
                        </section>
            ...
            <footer className="bg-gray-100 dark:bg-gray-800 py-8 mt-12">
                <div className="max-w-7xl mx-auto px-4 text-center">
                    ...
                    <p className="text-gray-600 dark:text-gray-400 max-w-lg mx-auto">
                        The mysteries of our planet continue to unfold, connecting ancient texts with modern scientific discoveries.
                    </p>
