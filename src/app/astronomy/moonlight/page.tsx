          ...
          <div className="lg:col-span-3 space-y-12">
              ...
              <Card className="border-l-4 border-blue-500">
                ...
                <CardContent className="pt-4 space-y-4">
                  <p className="font-medium">
                    Many ancient texts described the moon as a light-giving
                    body, similar to the sun. Today, we know this is incorrect -
                    the moon doesn't generate its own light but reflects
                    sunlight.
                  </p>
                  <div className="bg-blue-50 dark:bg-blue-900/30 p-6 rounded-lg border border-blue-100 dark:border-blue-800">
                    ...
                    <p>
                      ...
                      moon doesn't shine. Visible light from the moon is
                      actually reflected sunlight. However the Quran didn't make
                      this mistake.
                    </p>
                  </div>
                </CardContent>
                ...
                <CardContent className="pt-4 space-y-4">
                  <div className="bg-amber-50 dark:bg-amber-900/30 p-6 rounded-lg border border-amber-100 dark:border-amber-800">
                    <h3 className="font-medium mb-2 flex items-center gap-2">
                      <Quote size={16} className="text-amber-500" /> Modern
                      Understanding
                    </h3>
                    <p className="italic text-gray-700 dark:text-gray-300">
                      "The Moon shines because its surface reflects light from
                      the Sun. But the Moon doesn't just reflect light like a
                      mirror. Instead, it absorbs some light and reflects the
                      rest in all directions. The type of surface and presence
                      of elements like titanium affect how much light is
                      reflected.
                      <br />
                      <br />
                      As the Moon orbits Earth, different amounts of its sunlit
                      surface are visible from our planet. This creates the
                      lunar phases we observe throughout the month."
                    </p>
                  </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-6">
                    <div className="bg-gray-100 dark:bg-gray-800 p-4 rounded-lg">
                      <h3 className="font-medium mb-2 flex items-center gap-2">
                        <Sun size={16} className="text-amber-500" /> The Sun:
                        Light Source
                      </h3>
                      <p>
                    ...
                    <div className="bg-gray-100 dark:bg-gray-800 p-4 rounded-lg">
                      <h3 className="font-medium mb-2 flex items-center gap-2">
                        <Moon size={16} className="text-blue-500" /> The Moon:
                        Reflector
                      </h3>
                      <p>
                        Unlike the sun, the moon has no internal energy source
                        to produce light. It merely reflects approximately 12%
              ...
              <Card className="border-l-4 border-green-500">
                ...
                <CardContent className="pt-4 space-y-4">
                  <div className="bg-green-50 dark:bg-green-900/30 p-6 rounded-lg border border-green-100 dark:border-green-800">
                    ...
                    <div className="flex flex-col md:flex-row md:space-x-6">
                      ...
                      <div className="md:w-1/2 font-arabic text-right text-lg">
                        <p dir="rtl">
                          ٥ هُوَ الَّذِي جَعَلَ الشَّمْسَ ضِيَاءً وَالْقَمَرَ
                          نُورًا وَقَدَّرَهُ مَنَازِلَ لِتَعْلَمُوا عَدَدَ
                          السِّنِينَ وَالْحِسَابَ ۚ مَا خَلَقَ اللَّهُ ذَٰلِكَ
                          إِلَّا بِالْحَقِّ ۚ يُفَصِّلُ الْآيَاتِ لِقَوْمٍ
                          يَعْلَمُون
                        </p>
                      </div>
                    </div>
                  ...
                  <div className="mt-6">
                    ...
                    <p className="mt-3">
                      Note that the verse uses different words to describe the
                      sun (ضِيَاءً) and the moon (نُورًا). The word used for the
                      sun refers to something that generates its own light,
                      while the word used for the moon refers to borrowed or
                      reflected light.
                    </p>
                  </div>

                  <p>Only the sun shines. No mistakes in the Quran.</p>
                </CardContent>
              </Card>
            </section>
            ...
            <section id="reflection" className="scroll-mt-20">
              <Card className="border-l-4 border-purple-500">
                ...
                <CardContent className="pt-4 space-y-4">
                  <p>
                    The accurate distinction between sunlight and moonlight in
                    the Quran raises intriguing questions about ancient
                    knowledge:
                  </p>
                  ...
                  <div className="bg-purple-50 dark:bg-purple-900/30 p-6 rounded-lg border border-purple-100 dark:border-purple-800">
                    ...
                    <p>
                      ...
                      understanding of astronomy. At a time when many believed
                      the moon generated its own light, the Quran made a
                      distinction that science would only confirm centuries
                      later.
                    </p>
                  </div>
                  ...
                  <p>
                    ...
                    scientific or spiritual perspective, the celestial bodies
