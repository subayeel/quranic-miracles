    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 text-gray-800 dark:text-gray-200">
      ...
      <div className="bg-gradient-to-r from-yellow-500 to-orange-600 dark:from-yellow-600 dark:to-orange-700 text-white py-12">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <p className="text-xl max-w-2xl text-yellow-100">Biology - Extreme</p>
              ...
              <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 border-l-4 border-l-yellow-500">
                ...
                <div className="p-6 space-y-4">
                  <p className="font-medium">
                    ...
                    that reveals the incredible power of lightning and its
                  ...
                  <div className="bg-orange-50 dark:bg-orange-900/30 p-6 rounded-lg border border-orange-100 dark:border-orange-800">
                    ...
                    <p>
                      <strong>
                        1400 years ago nobody knew about keraunoparalysis
                        however it was portrayed in the Quran.
                      </strong>{" "}
                      This medical condition was only scientifically understood
                      and named in recent decades, yet ancient texts described
                      the phenomenon with remarkable accuracy.
                    </p>
                  </div>
                </div>
              </div>
                ...
                <div className="p-6 space-y-4">
                  <div className="bg-red-50 dark:bg-red-900/30 p-6 rounded-lg border border-red-100 dark:border-red-800">
                    <h3 className="font-medium mb-2 flex items-center gap-2">
                      <Quote size={16} className="text-red-500" /> Medical
                      Definition
                    </h3>
                    <p className="italic text-gray-700 dark:text-gray-300">
                      ...
                      keraunoparalysis include lack of pulse, pallor or
                      cyanosis, and motor and sensory loss in the extremities.
                      However, keraunoparalysis usually resolves within a few
                      hours."
                    </p>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-6">
                    ...
                    <div className="bg-gray-100 dark:bg-gray-800 p-4 rounded-lg">
                      ...
                      <p className="text-sm">
                        The good news is that keraunoparalysis is temporary.
                        Most patients recover full function within a few hours
                        to a day after the lightning strike, as the nervous
                  ...
                  <p className="font-medium">
                    A lightning strike can cause temporary paralysis. This
                    medical phenomenon was only recently understood and
                    documented, however it was described in the Quran 1400 years
                ...
                <div className="p-6 space-y-4">
                    ...
                    <div className="flex flex-col md:flex-row md:space-x-6">
                      <div className="md:w-1/2">
                        <p className="italic mb-4">
                          ...
                          lightning struck them as they looked on. They could
                          not rise up, nor could they find help."
                        </p>
                      </div>
                  ...
                  <div className="mt-6">
                    ...
                    <p className="mt-3">
                      ...
                      that prevents the victim from standing or moving, exactly
                      as described in this ancient verse.
                    </p>
                  </div>
                  ...
                  <div className="bg-blue-50 dark:bg-blue-900/30 p-4 rounded-lg border border-blue-100 dark:border-blue-800">
                    ...
                    <p className="text-sm">
                      ...
                      medicine knows about keraunoparalysis: victims of
                      lightning strikes are conscious ("as they looked on") but
                      unable to move or stand up ("could not rise up"). This
                      specific detail about the inability to stand is a hallmark
                      symptom of keraunoparalysis.
                    </p>
                  </div>
                </div>
              </div>
                ...
                <div className="p-6 space-y-4">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="bg-gray-100 dark:bg-gray-800 p-4 rounded-lg">
                      ...
                      <p className="text-sm">
                        In the 7th century, medical knowledge was limited, and
                        the specific effects of lightning on the human nervous
                        system were completely unknown. The detailed description
                        of paralysis following lightning strikes shows
                    ...
                    <div className="bg-gray-100 dark:bg-gray-800 p-4 rounded-lg">
                      ...
                      <p className="text-sm">
                        ...
                        leaving victims conscious. This alignment between
                        ancient text and modern science is striking.
                      </p>
                    </div>
                  </div>
                  ...
                  <p>
                    ...
                    science can illuminate each other, encouraging us to
      ...
      <footer className="bg-gray-100 dark:bg-gray-800 py-8 mt-12">
        <div className="max-w-7xl mx-auto px-4 text-center">
          ...
          <p className="text-gray-600 dark:text-gray-400 max-w-lg mx-auto">
            Understanding keraunoparalysis bridges the gap between ancient
